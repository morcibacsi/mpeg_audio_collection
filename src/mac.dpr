...
uses
  ...
  RtlVclOptimize in 'FastCode\RtlVclOptimize.pas',
  ...
  EditOggTag in 'Units\EditOggTag.pas' {FormEditOggTag},
  EditTag in 'Units\EditTag.pas' {FormEditTag},
