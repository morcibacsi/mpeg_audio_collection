object frmTagger: TfrmTagger
  ...
  object gbCapitalize: TGroupBox
    ...
    object cbSecify: TCheckBox
      Left = 8
      Top = 48
      Width = 161
      Height = 17
      Anchors = [akLeft, akRight]
      Caption = '_Use only for specified tags'
      Enabled = False
      TabOrder = 1
      OnClick = cbSecifyClick
    end
    object bExceptions: TButton
      Left = 8
      Top = 68
      Width = 81
      Height = 25
  ...
  object gbReplace: TGroupBox
    ...
    Caption = '_Replace'
    TabOrder = 4
    object cbUseReplacement: TCheckBox
      Left = 8
      Top = 18
      Width = 169
      Height = 17
      Caption = '_Use replacement-filter'
      TabOrder = 0
      OnClick = cbUseReplacementClick
    end
  ...
  object gbTag: TGroupBox
    ...
    object cbCapsComment: TCheckBox
      Left = 332
      Top = 260
      Width = 17
      Height = 21
  ...
  object cbOnlyExisting: TCheckBox
    Left = 368
    Top = 422
    Width = 193
    Height = 17
    Anchors = [akRight, akBottom]
    Caption = '_Write only in existing tag-formats'
    TabOrder = 10
    OnClick = cbOnlyExistingClick
  end
  object gbWizards: TGroupBox
    Left = 8
    Top = 180
    Width = 545
    Height = 50
    ...
    TabOrder = 3
    OnDragOver = FormDragOver
    object bFile2Tag: TButton
      Left = 8
      Top = 16
      Width = 81
      Height = 25
      Caption = '_Filename>Tag'
      TabOrder = 0
      OnClick = bFile2TagClick
    end
    object bNumberation: TButton
      Left = 96
      Top = 16
      Width = 81
      Height = 25
      Caption = '_Numeration'
      TabOrder = 1
      OnClick = bNumberationClick
    end
    object bRemTags: TButton
      Left = 184
      Top = 16
      Width = 81
      Height = 25
      ...
      TabOrder = 2
      OnClick = bRemTagsClick
    end
    object bFreedb: TButton
      Left = 272
      Top = 16
      Width = 81
      Height = 25
